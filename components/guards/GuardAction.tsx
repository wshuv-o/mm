import { GuardActionConf } from "@/hooks/useGuardConf";
import {
  ActivityIndicator,
  StyleSheet,
  TouchableOpacity,
...
type props = { actionConf: GuardActionConf; hasRunningMutation?: boolean };
export default function GuardAction({ actionConf, hasRunningMutation }: props) {
  return (
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        {/* NOTE MAYBE ADD SUBTITLE/DESCRIPTION ETC */}
        ...
        {actionConf?.action && !hasRunningMutation && (
          <TouchableOpacity
            style={styles.button}
            onPress={actionConf.action.fn}
          >
            <Text style={styles.buttonText}>{actionConf.action.label}</Text>
          </TouchableOpacity>
        )}
      </View>
    </View>
